...
".configurable)}),getPrototypeOf:d(function getPrototypeOf(K){return j(K,\"prototype\")})});if(a.eJ&&b)eval(b);if(h.toS"
"tring()!==\"NaN\")throw Error(\"Internal self test failed. Check C++ compiler options concerning IEEE 754 compliance."
"\")})"
;
#if (NUXJS_ES5)
const char* STDLIB_ES5_JS =
"function defineProperties(a,b,c){var d=b.readOnly,e=b.dontEnum,f=b.dontDelete;for(var g in c)h.defineProperty(a,g,c[g]"
",d,e,f);return a}defineProperties(String.prototype,{dontEnum:true},{trimLeft:i(function trimLeft(){var j=str(this),k=0"
",l=j.length,m;for(;k<l;++k){m=j.charCodeAt(k);if(m!==0x20&&(m<0x09||m>0x0D)&&m!==0xA0&&m!==0x2028&&m!==0x2029&&m!==0xF"
"EFF)break}return $sub(j,k,l)}),trimRight:i(function trimRight(){var j=str(this),l=j.length,m;for(;l>0;--l){m=j.charCod"
"eAt(l-1);if(m!==0x20&&(m<0x09||m>0x0D)&&m!==0xA0&&m!==0x2028&&m!==0x2029&&m!==0xFEFF)break}return $sub(j,0,l)}),trim:i"
"(function trim(){var j=str(this),k=0,l=j.length,m;for(;k<l;++k){m=j.charCodeAt(k);if(m!==0x20&&(m<0x09||m>0x0D)&&m!==0"
"xA0&&m!==0x2028&&m!==0x2029&&m!==0xFEFF)break}for(;l>k;--l){m=j.charCodeAt(l-1);if(m!==0x20&&(m<0x09||m>0x0D)&&m!==0xA"
"0&&m!==0x2028&&m!==0x2029&&m!==0xFEFF)break}return $sub(j,k,l)})});defineProperties(Array.prototype,{dontEnum:true},{f"
"orEach:i(function forEach(n){var o=Object(this),p=uint32(o.length),q=arguments[1];if(typeof n!==\"function\")throw Typ"
"eError();for(var r=0;r<p;++r)if(r in o)n.call(q,o[r],r,o)}),map:i(function map(n){var o=Object(this),p=uint32(o.length"
"),q=arguments[1],s=new Array(p);if(typeof n!==\"function\")throw TypeError();for(var r=0;r<p;++r)if(r in o)s[r]=n.call"
"(q,o[r],r,o);return s}),filter:i(function filter(n){var o=Object(this),p=uint32(o.length),q=arguments[1],s=[],t=0;if(t"
"ypeof n!==\"function\")throw TypeError();for(var r=0;r<p;++r)if(r in o){var u=o[r];if(n.call(q,u,r,o))s[t++]=u}s.lengt"
"h=t;return s}),indexOf:i(function indexOf(v){var p=uint32(this.length),k=arguments[1];if(p===0)return-1;if((k=int(k))<"
"0){k+=p;if(k<0)k=0}for(;k<p;++k)if(k in this&&this[k]===v)return k;return-1}),lastIndexOf:i(function lastIndexOf(v){va"
"r p=uint32(this.length),k=arguments[1];if(p===0)return-1;if(k===void 0)k=p-1;else{k=int(k);if(k<0)k+=p;if(k>=p)k=p-1}f"
"or(;k>=0;--k)if(k in this&&this[k]===v)return k;return-1}),reduce:i(function reduce(n){var o=Object(this),p=uint32(o.l"
"ength),r=0,w;if(typeof n!==\"function\")throw TypeError();if(arguments.length>1)w=arguments[1];else{while(r<p&&!(r in "
"o))++r;if(r>=p)throw TypeError();w=o[r++]}for(;r<p;++r)if(r in o)w=n.call(void 0,w,o[r],r,o);return w}),reduceRight:i("
"function reduceRight(n){var o=Object(this),p=uint32(o.length),r=p-1,w;if(typeof n!==\"function\")throw TypeError();if("
"arguments.length>1)w=arguments[1];else{while(r>=0&&!(r in o))--r;if(r<0)throw TypeError();w=o[r--]}for(;r>=0;--r)if(r "
"in o)w=n.call(void 0,w,o[r],r,o);return w}),every:i(function every(n){var o=Object(this),p=uint32(o.length),q=argument"
"s[1];if(typeof n!==\"function\")throw TypeError();for(var r=0;r<p;++r)if(r in o&&!n.call(q,o[r],r,o))return false;retu"
"rn true}),some:i(function some(n){var o=Object(this),p=uint32(o.length),q=arguments[1];if(typeof n!==\"function\")thro"
"w TypeError();for(var r=0;r<p;++r)if(r in o&&n.call(q,o[r],r,o))return true;return false})});defineProperties(Date,{do"
"ntEnum:true},{now:i(function now(){return h.getCurrentTime()})});defineProperties(Object,{dontEnum:true},{defineProper"
"ty:i(function defineProperty(o,g,x){var r=str(g);var d=!x.writable,e=!x.enumerable,f=!x.configurable;if(\"get\"in x||"
"\"set\"in x){if(\"value\"in x||\"writable\"in x)throw TypeError();var y=x.get;var j=x.set;if(y!==undefined&&typeof y!="
"=\"function\")throw TypeError();if(j!==undefined&&typeof j!==\"function\")throw TypeError();h.defineProperty(o,r,undef"
"ined,d,e,f,y,j)}else{h.defineProperty(o,r,x.value,d,e,f)}}),defineProperties:i(function defineProperties(o,c){if(o===u"
"ndefined||o===null)throw TypeError();var z=Object(o);for(var r in c){if(Object.prototype.hasOwnProperty.call(c,r))Obje"
"ct.defineProperty(z,r,c[r])}return z}),create:i(function create(A,B){if(A===null)throw TypeError();var q=typeof A;if(q"
"!==\"object\"&&q!==\"function\")throw TypeError();var o=h.createWrapper(\"Object\",void 0,A);if(B!==void 0)Object.defi"
"neProperties(o,Object(B));return o}),keys:i(function keys(o){if(o===undefined||o===null)throw TypeError();var z=Object"
"(o);var C=[];var r;for(r in z)if(Object.prototype.hasOwnProperty.call(z,r))C[C.length]=r;return C})});"
;
#endif
}
