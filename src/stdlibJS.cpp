...
"defineProperties(String.a,{b:c},{trimLeft:unconstructable(d trimLeft(){e f=str(g),h=0,i=f.j,k;l(;h<i;++h){k=f.m(h);n(k"
"!==0x20&&(k<0x09||k>0x0D)&&k!==0xA0&&k!==0x2028&&k!==0x2029&&k!==0xFEFF)o}p $sub(f,h,i)}),trimRight:unconstructable(d "
"trimRight(){e f=str(g),i=f.j,k;l(;i>0;--i){k=f.m(i-1);n(k!==0x20&&(k<0x09||k>0x0D)&&k!==0xA0&&k!==0x2028&&k!==0x2029&&"
"k!==0xFEFF)o}p $sub(f,0,i)}),trim:unconstructable(d trim(){e f=str(g),h=0,i=f.j,k;l(;h<i;++h){k=f.m(h);n(k!==0x20&&(k<"
"0x09||k>0x0D)&&k!==0xA0&&k!==0x2028&&k!==0x2029&&k!==0xFEFF)o}l(;i>h;--i){k=f.m(i-1);n(k!==0x20&&(k<0x09||k>0x0D)&&k!="
"=0xA0&&k!==0x2028&&k!==0x2029&&k!==0xFEFF)o}p $sub(f,h,i)})});defineProperties(Array.a,{b:c},{forEach:unconstructable("
"d forEach(q){e r=Object(g),s=uint32(r.j),t=u[1];n(v q!==\"function\")w x();l(e y=0;y<s;++y)n(y z r)q.A(t,r[y],y,r)}),m"
"ap:unconstructable(d map(q){e r=Object(g),s=uint32(r.j),t=u[1],B=C Array(s);n(v q!==\"function\")w x();l(e y=0;y<s;++y"
")n(y z r)B[y]=q.A(t,r[y],y,r);p B}),filter:unconstructable(d filter(q){e r=Object(g),s=uint32(r.j),t=u[1],B=[],D=0;n(v"
" q!==\"function\")w x();l(e y=0;y<s;++y)n(y z r){e E=r[y];n(q.A(t,E,y,r))B[D++]=E}B.j=D;p B}),indexOf:unconstructable("
"d indexOf(F){e s=uint32(g.j),h=u[1];n(s===0)p-1;n((h=int(h))<0){h+=s;n(h<0)h=0}l(;h<s;++h)n(h z g&&g[h]===F)p h;p-1}),"
"lastIndexOf:unconstructable(d lastIndexOf(F){e s=uint32(g.j),h=u[1];n(s===0)p-1;n(h===G 0)h=s-1;H{h=int(h);n(h<0)h+=s;"
"n(h>=s)h=s-1}l(;h>=0;--h)n(h z g&&g[h]===F)p h;p-1}),reduce:unconstructable(d reduce(q){e r=Object(g),s=uint32(r.j),y="
"0,I;n(v q!==\"function\")w x();n(u.j>1)I=u[1];H{J(y<s&&!(y z r))++y;n(y>=s)w x();I=r[y++]}l(;y<s;++y)n(y z r)I=q.A(G 0"
",I,r[y],y,r);p I}),reduceRight:unconstructable(d reduceRight(q){e r=Object(g),s=uint32(r.j),y=s-1,I;n(v q!==\"function"
"\")w x();n(u.j>1)I=u[1];H{J(y>=0&&!(y z r))--y;n(y<0)w x();I=r[y--]}l(;y>=0;--y)n(y z r)I=q.A(G 0,I,r[y],y,r);p I}),ev"
"ery:unconstructable(d every(q){e r=Object(g),s=uint32(r.j),t=u[1];n(v q!==\"function\")w x();l(e y=0;y<s;++y)n(y z r&&"
"!q.A(t,r[y],y,r))p K;p c}),some:unconstructable(d some(q){e r=Object(g),s=uint32(r.j),t=u[1];n(v q!==\"function\")w x("
");l(e y=0;y<s;++y)n(y z r&&q.A(t,r[y],y,r))p c;p K})});defineProperties(Date,{b:c},{now:unconstructable(d now(){p L.M("
")})});defineProperties(Object,{b:c},{defineProperty:unconstructable(d defineProperty(r,N,O){e y=str(N);e P=!O.Q,R=!O.S"
",T=!O.U;n(\"get\"z O||\"set\"z O){n(\"value\"z O||\"writable\"z O)w x();e V=O.get;e f=O.set;n(V!==W&&v V!==\"function"
"\")w x();n(f!==W&&v f!==\"function\")w x();L.defineProperty(r,y,W,P,R,T,V,f)}H{L.defineProperty(r,y,O.X,P,R,T)}}),defi"
"neProperties:unconstructable(d defineProperties(r,Y){n(r===W||r===Z)w x();e a0=Object(r);l(e y z Y){n(Object.a.a1.A(Y,"
"y))Object.defineProperty(a0,y,Y[y])}p a0}),create:unconstructable(d create(a2,a3){n(a2===Z)w x();e t=v a2;n(t!==\"obje"
"ct\"&&t!==\"function\")w x();e r=L.a4(\"Object\",G 0,a2);n(a3!==G 0)Object.defineProperties(r,Object(a3));p r}),keys:u"
"nconstructable(d keys(r){n(r===W||r===Z)w x();e a0=Object(r);e a5=[];e y;l(y z a0)n(Object.a.a1.A(a0,y))a5[a5.j]=y;p a"
"5})});"
;
#endif
}
