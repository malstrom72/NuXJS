...
"defineProperties(String.prototype,{dontEnum:true},{trimLeft:function trimLeft(){var C=Q(this),v=0,b8=C.length,av;for(;"
"v<b8;++v){av=C.charCodeAt(v);if(av!==0x20&&(av<0x09||av>0x0D)&&av!==0xA0&&av!==0x2028&&av!==0x2029&&av!==0xFEFF)break}"
"return C.substring(v,b8)},trimRight:function trimRight(){var C=Q(this),b8=C.length,av;for(;b8>0;--b8){av=C.charCodeAt("
"b8-1);if(av!==0x20&&(av<0x09||av>0x0D)&&av!==0xA0&&av!==0x2028&&av!==0x2029&&av!==0xFEFF)break}return C.substring(0,b8"
")},trim:function trim(){var C=Q(this),v=0,b8=C.length,av;for(;v<b8;++v){av=C.charCodeAt(v);if(av!==0x20&&(av<0x09||av>"
"0x0D)&&av!==0xA0&&av!==0x2028&&av!==0x2029&&av!==0xFEFF)break}for(;b8>v;--b8){av=C.charCodeAt(b8-1);if(av!==0x20&&(av<"
"0x09||av>0x0D)&&av!==0xA0&&av!==0x2028&&av!==0x2029&&av!==0xFEFF)break}return C.substring(v,b8)}});defineProperties(Ar"
"ray.prototype,{dontEnum:true},{forEach:function forEach(eJ){var K=Object(this),az=P(K.length),I=arguments[1];if(typeof"
" eJ!==\"function\")throw TypeError();for(var cM=0;cM<az;++cM)if(cM in K)eJ.call(I,K[cM],cM,K)},map:function map(eJ){va"
"r K=Object(this),az=P(K.length),I=arguments[1],aN=new Array(az);if(typeof eJ!==\"function\")throw TypeError();for(var "
"cM=0;cM<az;++cM)if(cM in K)aN[cM]=eJ.call(I,K[cM],cM,K);return aN},filter:function filter(eJ){var K=Object(this),az=P("
"K.length),I=arguments[1],aN=[],bs=0;if(typeof eJ!==\"function\")throw TypeError();for(var cM=0;cM<az;++cM)if(cM in K){"
"var H=K[cM];if(eJ.call(I,H,cM,K))aN[bs++]=H}aN.length=bs;return aN},indexOf:function indexOf(eK){var az=P(this.length)"
",v=arguments[1];if(az===0)return-1;v=N(v);if(v<0){v+=az;if(v<0)v=0}for(;v<az;++v)if(v in this&&this[v]===eK)return v;r"
"eturn-1},lastIndexOf:function lastIndexOf(eK){var az=P(this.length),v=arguments[1];if(az===0)return-1;if(v===void 0)v="
"az-1;else{v=N(v);if(v<0)v+=az;if(v>=az)v=az-1}for(;v>=0;--v)if(v in this&&this[v]===eK)return v;return-1},reduce:funct"
"ion reduce(eJ){var K=Object(this),az=P(K.length),cM=0,eL;if(typeof eJ!==\"function\")throw TypeError();if(arguments.le"
"ngth>1)eL=arguments[1];else{while(cM<az&&!(cM in K))++cM;if(cM>=az)throw TypeError();eL=K[cM++]}for(;cM<az;++cM)if(cM "
"in K)eL=eJ.call(void 0,eL,K[cM],cM,K);return eL},reduceRight:function reduceRight(eJ){var K=Object(this),az=P(K.length"
"),cM=az-1,eL;if(typeof eJ!==\"function\")throw TypeError();if(arguments.length>1)eL=arguments[1];else{while(cM>=0&&!(c"
"M in K))--cM;if(cM<0)throw TypeError();eL=K[cM--]}for(;cM>=0;--cM)if(cM in K)eL=eJ.call(void 0,eL,K[cM],cM,K);return e"
"L},every:function every(eJ){var K=Object(this),az=P(K.length),I=arguments[1];if(typeof eJ!==\"function\")throw TypeErr"
"or();for(var cM=0;cM<az;++cM)if(cM in K&&!eJ.call(I,K[cM],cM,K))return false;return true},some:function some(eJ){var K"
"=Object(this),az=P(K.length),I=arguments[1];if(typeof eJ!==\"function\")throw TypeError();for(var cM=0;cM<az;++cM)if(c"
"M in K&&eJ.call(I,K[cM],cM,K))return true;return false}});defineProperties(Date,{dontEnum:true},{now:function now(){re"
"turn new Date().getTime()}});defineProperties(Object,{dontEnum:true},{defineProperty:function defineProperty(K,Y,cc){v"
"ar cM=Q(Y);var V=!cc.writable,W=!cc.enumerable,X=!cc.configurable;if(\"get\"in cc||\"set\"in cc){if(\"value\"in cc||\""
"writable\"in cc)throw TypeError();var eM=cc[\"get\"];var C=cc[\"set\"];if(eM!==undefined&&typeof eM!==\"function\")thr"
"ow TypeError();if(C!==undefined&&typeof C!==\"function\")throw TypeError();a.defineProperty(K,cM,undefined,V,W,X,eM,C)"
"}else{a.defineProperty(K,cM,cc.value,V,W,X)}},defineProperties:function defineProperties(K,U){if(K===undefined||K===nu"
"ll)throw TypeError();var eN=Object(K);for(var cM in U)if(Object.prototype.hasOwnProperty.call(U,cM))Object.definePrope"
"rty(eN,cM,U[cM]);return eN},create:function create(eO,eP){if(eO===null)throw TypeError();var I=typeof eO;if(I!==\"obje"
"ct\"&&I!==\"function\")throw TypeError();function eQ(){}eQ.prototype=eO;var K=new eQ();if(eP!==void 0)Object.definePro"
"perties(K,Object(eP));return K},keys:function keys(K){if(K===undefined||K===null)throw TypeError();var eN=Object(K),eR"
"=[],cM;for(cM in eN)if(Object.prototype.hasOwnProperty.call(eN,cM))eR[eR.length]=cM;return eR}});defineProperties(Func"
"tion.prototype,{dontEnum:true},{bind:function bind(an){var eS=this;if(typeof eS!=='function')throw TypeError();var eT="
"Array.prototype.slice.call(arguments,1);function eU(aN){var eV=eT.concat(Array.prototype.slice.call(arguments));if(thi"
"s instanceof eU){if(!eS||!eS.prototype)throw TypeError();function eW(){}eW.prototype=eS.prototype;var bj=new eW();var "
"eX=eS.apply(bj,eV);return(eX&&(typeof eX==='object'||typeof eX==='function'))?eX:bj}return eS.apply(an,eV)}return eU}}"
");"
;
#endif
}
