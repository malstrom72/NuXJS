...
"his;if(typeof eS!=='function')throw TypeError();var eT=Array.prototype.slice.call(arguments,1);function eU(aN){var eV="
"eT.concat(Array.prototype.slice.call(arguments));if(this instanceof eU){if(!eS||!eS.prototype)throw TypeError();functi"
"on eW(){}eW.prototype=eS.prototype;var bj=new eW();var eX=eS.apply(bj,eV);return(eX&&(typeof eX==='object'||typeof eX="
"=='function'))?eX:bj}return eS.apply(an,eV)}a.setFunctionLength(eU,Math.max(0,eS.length-eT.length));return eU}});"
;
#endif
}
