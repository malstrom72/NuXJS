...
".configurable)}),getPrototypeOf:d(function getPrototypeOf(K){return j(K,\"prototype\")})});if(a[\"ES5\"]&&b)eval(b);if"
"(h.toString()!==\"NaN\")throw Error(\"Internal self test failed. Check C++ compiler options concerning IEEE 754 compli"
"ance.\")})"
;
#if (NUXJS_ES5)
const char* STDLIB_ES5_JS =
"function defineProperties(S,T,U){var V=T&&T.readOnly===true;var W=T&&T.dontEnum===true;var X=T&&T.dontDelete===true;fo"
"r(var cM in U)if(Object.prototype.hasOwnProperty.call(U,cM)){Object.defineProperty(S,cM,{value:U[cM],writable:!V,enume"
"rable:!W,configurable:!X})}return S}function eJ(H){H=+H;if(H!==H)return 0;if(H===0||H===Infinity||H===-Infinity)return"
" H;return(H<0?Math.ceil(H):Math.floor(H))}function eK(H){return eJ(H)>>>0}function eL(K){return String(K)}defineProper"
"ties(String.prototype,{dontEnum:true},{trimLeft:function trimLeft(){var C=eL(this),v=0,b8=C.length,av;for(;v<b8;++v){a"
"v=C.charCodeAt(v);if(av!==0x20&&(av<0x09||av>0x0D)&&av!==0xA0&&av!==0x2028&&av!==0x2029&&av!==0xFEFF)break}return C.su"
"bstring(v,b8)},trimRight:function trimRight(){var C=eL(this),b8=C.length,av;for(;b8>0;--b8){av=C.charCodeAt(b8-1);if(a"
"v!==0x20&&(av<0x09||av>0x0D)&&av!==0xA0&&av!==0x2028&&av!==0x2029&&av!==0xFEFF)break}return C.substring(0,b8)},trim:fu"
"nction trim(){var C=eL(this),v=0,b8=C.length,av;for(;v<b8;++v){av=C.charCodeAt(v);if(av!==0x20&&(av<0x09||av>0x0D)&&av"
"!==0xA0&&av!==0x2028&&av!==0x2029&&av!==0xFEFF)break}for(;b8>v;--b8){av=C.charCodeAt(b8-1);if(av!==0x20&&(av<0x09||av>"
"0x0D)&&av!==0xA0&&av!==0x2028&&av!==0x2029&&av!==0xFEFF)break}return C.substring(v,b8)}});defineProperties(Array.proto"
"type,{dontEnum:true},{forEach:function forEach(eM){var K=Object(this),az=eK(K.length),I=arguments[1];if(typeof eM!==\""
"function\")throw TypeError();for(var cM=0;cM<az;++cM)if(cM in K)eM.call(I,K[cM],cM,K)},map:function map(eM){var K=Obje"
"ct(this),az=eK(K.length),I=arguments[1],aN=new Array(az);if(typeof eM!==\"function\")throw TypeError();for(var cM=0;cM"
"<az;++cM)if(cM in K)aN[cM]=eM.call(I,K[cM],cM,K);return aN},filter:function filter(eM){var K=Object(this),az=eK(K.leng"
"th),I=arguments[1],aN=[],bs=0;if(typeof eM!==\"function\")throw TypeError();for(var cM=0;cM<az;++cM)if(cM in K){var H="
"K[cM];if(eM.call(I,H,cM,K))aN[bs++]=H}aN.length=bs;return aN},indexOf:function indexOf(eN){var az=eK(this.length),v=ar"
"guments[1];if(az===0)return-1;v=eJ(v);if(v<0){v+=az;if(v<0)v=0}for(;v<az;++v)if(v in this&&this[v]===eN)return v;retur"
"n-1},lastIndexOf:function lastIndexOf(eN){var az=eK(this.length),v=arguments[1];if(az===0)return-1;if(v===void 0)v=az-"
"1;else{v=eJ(v);if(v<0)v+=az;if(v>=az)v=az-1}for(;v>=0;--v)if(v in this&&this[v]===eN)return v;return-1},reduce:functio"
"n reduce(eM){var K=Object(this),az=eK(K.length),cM=0,eO;if(typeof eM!==\"function\")throw TypeError();if(arguments.len"
"gth>1)eO=arguments[1];else{while(cM<az&&!(cM in K))++cM;if(cM>=az)throw TypeError();eO=K[cM++]}for(;cM<az;++cM)if(cM i"
"n K)eO=eM.call(void 0,eO,K[cM],cM,K);return eO},reduceRight:function reduceRight(eM){var K=Object(this),az=eK(K.length"
"),cM=az-1,eO;if(typeof eM!==\"function\")throw TypeError();if(arguments.length>1)eO=arguments[1];else{while(cM>=0&&!(c"
"M in K))--cM;if(cM<0)throw TypeError();eO=K[cM--]}for(;cM>=0;--cM)if(cM in K)eO=eM.call(void 0,eO,K[cM],cM,K);return e"
"O},every:function every(eM){var K=Object(this),az=eK(K.length),I=arguments[1];if(typeof eM!==\"function\")throw TypeEr"
"ror();for(var cM=0;cM<az;++cM)if(cM in K&&!eM.call(I,K[cM],cM,K))return false;return true},some:function some(eM){var "
"K=Object(this),az=eK(K.length),I=arguments[1];if(typeof eM!==\"function\")throw TypeError();for(var cM=0;cM<az;++cM)if"
"(cM in K&&eM.call(I,K[cM],cM,K))return true;return false}});defineProperties(Date,{dontEnum:true},{now:function now(){"
"return new Date().getTime()}});defineProperties(Object,{dontEnum:true},{defineProperty:function defineProperty(K,Y,cc)"
"{var cM=eL(Y);var V=!cc.writable,W=!cc.enumerable,X=!cc.configurable;if(\"get\"in cc||\"set\"in cc){if(\"value\"in cc|"
"|\"writable\"in cc)throw TypeError();var eP=cc[\"get\"];var C=cc[\"set\"];if(eP!==undefined&&typeof eP!==\"function\")"
"throw TypeError();if(C!==undefined&&typeof C!==\"function\")throw TypeError();a.defineProperty(K,cM,undefined,V,W,X,eP"
",C)}else{a.defineProperty(K,cM,cc.value,V,W,X)}},defineProperties:function defineProperties(K,U){if(K===undefined||K=="
"=null)throw TypeError();var eQ=Object(K);for(var cM in U)if(Object.prototype.hasOwnProperty.call(U,cM))Object.definePr"
"operty(eQ,cM,U[cM]);return eQ},create:function create(eR,eS){if(eR===null)throw TypeError();var I=typeof eR;if(I!==\"o"
"bject\"&&I!==\"function\")throw TypeError();function eT(){}eT.prototype=eR;var K=new eT();if(eS!==void 0)Object.define"
"Properties(K,Object(eS));return K},keys:function keys(K){if(K===undefined||K===null)throw TypeError();var eQ=Object(K)"
",eU=[],cM;for(cM in eQ)if(Object.prototype.hasOwnProperty.call(eQ,cM))eU[eU.length]=cM;return eU}});defineProperties(F"
"unction.prototype,{dontEnum:true},{bind:function bind(an){var eV=this;if(typeof eV!=='function')throw TypeError();var "
"eW=Array.prototype.slice.call(arguments,1);function eX(aN){var eY=eW.concat(Array.prototype.slice.call(arguments));if("
"this instanceof eX){if(!eV||!eV.prototype)throw TypeError();function eZ(){}eZ.prototype=eV.prototype;var bj=new eZ();v"
"ar f0=eV.apply(bj,eY);return(f0&&(typeof f0==='object'||typeof f0==='function'))?f0:bj}return eV.apply(an,eY)}return e"
"X}});"
;
#endif
}
