...
"oPrimitiveNumber(this);return f(D)?D:null}});R(Object,{dontEnum:true},{defineProperty:d(function defineProperty(K,Y,cc"
"){var cM=Q(Y);var V=!cc.writable,W=!cc.enumerable,X=!cc.configurable;if(\"get\"in cc||\"set\"in cc){if(\"value\"in cc|"
"|\"writable\"in cc)throw TypeError();var eQ=cc[\"get\"];var C=cc[\"set\"];if(eQ!==undefined&&typeof eQ!==\"function\")"
"throw TypeError();if(C!==undefined&&typeof C!==\"function\")throw TypeError();a.defineProperty(K,cM,undefined,V,W,X,eQ"
",C)}else{a.defineProperty(K,cM,cc.value,V,W,X)}}),defineProperties:d(function defineProperties(K,U){if(K===undefined||"
"K===null)throw TypeError();var eR=Object(K);for(var cM in U)if(Object.prototype.hasOwnProperty.call(U,cM))Object.defin"
"eProperty(eR,cM,U[cM]);return eR}),create:d(function create(eS,eT){if(eS===null)throw TypeError();var I=typeof eS;if(I"
"!==\"object\"&&I!==\"function\")throw TypeError();function eU(){}eU.prototype=eS;var K=new eU();if(eT!==void 0)Object."
"defineProperties(K,Object(eT));return K}),keys:d(function keys(K){if(K===undefined||K===null)throw TypeError();var eR="
"Object(K),eV=[],cM;for(cM in eR)if(Object.prototype.hasOwnProperty.call(eR,cM))eV[eV.length]=cM;return eV})});R(Functi"
"on.prototype,{dontEnum:true},{bind:function bind(an){var eW=this;if(typeof eW!=='function')throw TypeError();var aF=[e"
"W,an];for(var v=1;v<arguments.length;++v)aF[aF.length]=arguments[v];return a.bind.apply(null,aF)}});"
;
#endif
}
