...
if [ "$es5" = "1" ]; then
TEST_DIRS=(../tests/conforming ../tests/erroneous ../tests/es3only ../tests/es5 ../tests/extremes ../tests/migrated ../tests/regression ../tests/stdlib ../tests/unconforming ../tests/unsorted)
else
