...
See `docs/NuXJS Documentation.md` for details on how `src/stdlib.js` is minified and converted to `src/stdlibJS.cpp` during the build, and `docs/Standard Library Guidelines.md` for authoring and editing the standard library. For ECMAScript semantics consult the Markdown copy of the ES5.1 specification at `docs/specs/ECMA-262 5.1.md`.
