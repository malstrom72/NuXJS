...
`tests/from262/objectIsSealedPrimitive.io`,
`tests/from262/objectGetPrototypeOfPrimitive.io`,
`tests/from262/arrayReduceEmptyNoInit.io`,
`tests/from262/arrayReduceRightEmptyNoInit.io`)
- [x] Import the ES5.1 section of Test262 and hook them into the `tests/from262` runner so failures can be tracked. (`tools/runTest262.sh`, `tests/from262/arrayReduceEmptyNoInit.io`, `tests/from262/arrayReduceRightEmptyNoInit.io`)
