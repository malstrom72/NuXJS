...
## Specification compliance and tests

- Implement each routine strictly according to the ECMAScript 5.1 specification (`docs/specs/ECMA-262 5.1.md`).
- Add tests that exercise all observable details of the relevant spec clauses.
